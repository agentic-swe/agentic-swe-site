...
`npm run verify` runs **`verify-sanity`** plus **`catalog:lint`**, so catalog regressions fail the same check used in [GitHub Actions](https://github.com/agentic-swe/agentic-swe/blob/main/.github/workflows/ci.yml).

## Maintainer spec

Repo: [`docs/specs/catalog-routing.md`](https://github.com/agentic-swe/agentic-swe/blob/main/docs/specs/catalog-routing.md) (implementation paths and env vars).
