...
See **`commands/check.md`** in the pack for **`init`**, **`plan-transition`**, **`transition`**, and **`record-cost`**. Spec: [work-item-engine.md](https://github.com/agentic-swe/agentic-swe/blob/main/docs/specs/work-item-engine.md) in the repo.
